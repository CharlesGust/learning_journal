...
def update_entry(entry_id, entry_title, entry_text):
    ...
    con = get_database_connection()
    cur = con.cursor()
    cur.execute(DB_UPDATE_SINGLE_ENTRY, (entry_title, entry_text, entry_id))
    return
...
def edit_entry():
    ...
    update_entry(entry_id,
                 request.form['edit_title' + entry_id],
                 request.form['edit_text' + entry_id])
    return redirect(url_for('show_entries'))
